	...
	return (
		<div className='relative overflow-hidden'>
			...
			<div className={cn('w-full min-h-screen flex flex-col', className)}>
				...
				<div className='fixed inset-0 z-0'>{background || <div className='w-full h-full bg-gray-100' />}</div>

				{/* Main content wrapper */}
				<div className='flex flex-col flex-grow z-10 overflow-x-hidden'>
					{/* Hero Container (fixed height) */}
					{heroContainer && (
						<div className='w-full z-[5] h-[70vh] md:h-[52vh] lg:pt-0'>{heroContainer}</div>
					)}
